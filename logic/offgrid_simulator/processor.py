...
# DIFFERENT DAY (MON/TUE/WED AS WEEKENDS ARE WEIRD) TIME SERIES TO SHOW DAILY USES,
# EQUATOR SPRING, EQUATOR FALL, MIDSUMMER AND MIDWINTER DAYS
...
# DUMP INPUT JSON TO RESULT FOLDER SO CAN BE RUN AGAIN X
