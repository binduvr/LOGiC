...
class output:
    ...
    def save_mg_flows(experiment, case_dict, e_flows_df, filename):
        ...
        # NOTE: Removed name of project from electricity_mg filenames
        if experiment['save_to_csv_flows_electricity_mg'] == True:
            mg_flows.to_csv(experiment['output_folder'] + '/electricity_mg/electricity_mg.csv')
        ...
        if experiment['save_to_png_flows_electricity_mg'] == True:
            ...
            for timeframe in ['year', 'days']:
                if timeframe == 'year':
                    ...
                    plt.savefig(experiment['output_folder'] + '/electricity_mg/electricity_mg.png',
                        bbox_inches="tight")
                    ...
                    plt.savefig(experiment['output_folder'] + '/electricity_mg/electricity_mg_4days.png',
                        bbox_inches="tight")
                plt.close()
                plt.clf()
                plt.cla()
