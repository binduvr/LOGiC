...
\end{itemize}
In all cases renewable sources are often considered as a possible source of energy for the microgrid, either from an economic or a sustainable driver. In the case of this microgrid the following sources are considered: wind power, solar power and a back-up generator.
...
Installed wind power&4.61&kW\\ 
Installed backup power&52.56&kW\\ 
\hline
\end{tabular}
\label{tab:systemlayout}
\captionof{table}{Sizing of the main components of the system}\end{center}\vspace{0.5mm}
The system defined by the parameters above realises a levelised cost of electricity of \texteuro 0.27 per kWh. the system does this at a renewable energy share of 8.0 \%. 
...
Wind turbines&\texteuro \hfill13,953.51\\ 
Backup generator&\texteuro \hfill63,989.15\\ 
