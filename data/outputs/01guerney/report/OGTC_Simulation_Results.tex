...
Installed solar power&929.20&kWp\\ 
Installed wind power&1,270.38&kW\\ 
Installed backup power&550.96&kW\\ 
\hline
\end{tabular}
\label{tab:systemlayout}
\end{flushleft}}\captionof{table}{Sizing of the main components of the system}\vspace{0.5mm}
The system defined by the parameters above realises a levelised cost of electricity of \texteuro 0.35 per kWh. the system does this at a renewable energy share of 75.4 \%. 
...
Solar modules&\texteuro \hfill1,459,206.48\\ 
Wind turbines&\texteuro \hfill3,842,912.09\\ 
Backup generator&\texteuro \hfill995,566.89\\ 
\hline
\end{tabular}
...
The total electricity demand has been been specified as 3500000 kWh per year and has been converted to a demand time series using historic load data collected by ENTSO-E.
